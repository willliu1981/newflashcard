...
public class MainView extends JFrame {
	...
	// public static final AutoPlayerFrame autoPlayerFrame = new
	// AutoPlayerFrame();
	public static final SimpleAutoPlayerFrame simpleAutoPlayerFrame = SimpleAutoPlayerFrame
			.getFrame();
	...
	private ShowRowControl<Vocabulary> vocabularyShowRowControl = new ShowRowControl(
			this);
	private TestQuestionControl<Vocabulary> testQuestionControl = new TestQuestionControl<Vocabulary>(
			this) {
		@Override
		...
		public Vocabulary getRandomAnswer() {
			...
			while (true) {
				...
				if (this.answers.get(idx).getId() != this.questions
						.get(this.currentQuestionIdx).getId()) {
					break;
				} else {
	...
	public MainView() {
		...
		mntmNewMenuItem_4.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent arg0) {
				//autoPlayerFrame.setVisible(true);
				//autoPlayerFrame.setState(JFrame.NORMAL);
			}
		});
		...
		*/
		...
		JMenuItem mntmNewMenuItem_5 = new JMenuItem("simple play");
		mntmNewMenuItem_5.addMouseListener(new MouseAdapter() {

			@Override
			public void mousePressed(MouseEvent e) {
				simpleAutoPlayerFrame.setVisible(true);
				simpleAutoPlayerFrame.setState(JFrame.NORMAL);
			}
		});
		mntmNewMenuItem_5
				.setFont(new Font("Microsoft JhengHei UI", Font.PLAIN, 14));
		 ...
		 */
		{
			...
			btnNewButton_topbar_vocabulary = new JButton(
					InfoProperty.getInfo(InfoProperty.Vocabulary));
			panel_4.add(btnNewButton_topbar_vocabulary);
			btnNewButton_topbar_vocabulary.setFocusPainted(false);
			btnNewButton_topbar_vocabulary
					.setPreferredSize(new Dimension(100, 28));
			btnNewButton_topbar_vocabulary.setBorder(new SoftBevelBorder(
					BevelBorder.RAISED, null, null, null, null));
			btnNewButton_topbar_vocabulary
					.setBackground(SystemColor.controlHighlight);
			btnNewButton_topbar_vocabulary
					.setFont(new Font("Dialog", Font.PLAIN, 18));
			btnNewButton_topbar_cardbox = new JButton(
					InfoProperty.getInfo(InfoProperty.CardBox));
			panel_4.add(btnNewButton_topbar_cardbox);
			btnNewButton_topbar_cardbox.setFocusPainted(false);
			btnNewButton_topbar_cardbox
					.setPreferredSize(new Dimension(100, 28));
			btnNewButton_topbar_cardbox.setBorder(new SoftBevelBorder(
					BevelBorder.RAISED, null, null, null, null));
			btnNewButton_topbar_cardbox
					.setBackground(SystemColor.controlHighlight);
			btnNewButton_topbar_cardbox
			...
			btnNewButton_topbar_test = new JButton(
					InfoProperty.getInfo(InfoProperty.Test));
			...
			btnNewButton_topbar_test.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					((CardLayout) panel_main_centerbar.getLayout()).show(
							panel_main_centerbar,
							MainView.CardLayout_topbar_Test);
					((CardLayout) panel_test_center_cardlayout.getLayout())
							.show(panel_test_center_cardlayout,
									MainView.CardLayout_Test_List);
					List<CardBox> list = new CardBoxDao().queryAll();
					TestRow.setVocabularyQuantitiesInCardboxMap(
							new VocabularyDao().queryAll());
					List<CardBox> newlist = list.stream().filter(x -> {
						boolean r = false;
						if (TestRow.getVocabularyQuantitiesInCardboxMap()
								.containsKey(x.getId())) {
							r = TestRow.getVocabularyQuantitiesInCardboxMap()
									.get(x.getId()) > 0;
						}
						return r;
					}).collect(Collectors.toList());
					...
					map.put(ShowRowInfo.Test_Quantity,
							String.valueOf(list.size()));
					cardboxShowRowControl.showInfo(map,
							ShowRowInfo.InfoName_Test);
				}
			});
			btnNewButton_topbar_test.setBorder(new SoftBevelBorder(
					BevelBorder.RAISED, null, null, null, null));
			btnNewButton_topbar_test
					.setBackground(SystemColor.controlHighlight);
			btnNewButton_topbar_test
					.setFont(new Font("Dialog", Font.PLAIN, 18));
			...
			btnNewButton_topbar_cardbox.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if (e.getActionCommand().equalsIgnoreCase(
							MainView.MouseEvent_RemoteClickUnResetFromIdx)) {
						btnNewButton_topbar_cardbox.setActionCommand(
								MouseEvent_RemoteClickResetFromIdx);
					} else {
						cardboxShowRowControl.resetFromIdx();
					}
					((CardLayout) panel_main_centerbar.getLayout()).show(
					...
					List<CardBox> list = new CardBoxDao().queryAll();
					CardBoxRow.setVocabularyQuantities(
							new VocabularyDao().queryAll());
					cardboxShowRowControl.setResults(list);
					cardboxShowRowControl.showRow();
					Map<String, String> map = new HashMap<>();
					map.put(ShowRowInfo.CardBox_Quantity,
							String.valueOf(list.size()));
					cardboxShowRowControl.showInfo(map,
							ShowRowInfo.InfoName_CardBox);
					((CardLayout) panel_cardbox_editbar.getLayout()).show(
							panel_cardbox_editbar, CardLayout_Editbar_Search);

					Map<String, String> map2 = new HashMap<>();
					map2.put(ShowRowInfo.Cardbox_Editbar_add_lock,
							CardVocabulary_Eidt);
					vocabularyShowRowControl.getEventResultMap().clear();
					cardboxShowRowControl.showInfo(map2,
			...
			btnNewButton_topbar_vocabulary
					.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							...
							if (e.getActionCommand().equalsIgnoreCase(
									MainView.MouseEvent_RemoteClickUnResetFromIdx)) {
								btnNewButton_topbar_vocabulary.setActionCommand(
										MouseEvent_RemoteClickResetFromIdx);
							} else {
								vocabularyShowRowControl.resetFromIdx();
							}
							vocabularyShowRowControl.setEventResultIdx(-1);// 消除選中
							((CardLayout) panel_main_centerbar.getLayout())
									.show(panel_main_centerbar,
											MainView.CardLayout_topbar_Vocabulary);
							List<Vocabulary> list = new VocabularyDao()
									.queryAll();
							vocabularyShowRowControl.setResults(list);
							Map<String, String> map = new HashMap<>();
							map.put(ShowRowInfo.Vocabulary_Quantity,
									String.valueOf(list.size()));
							vocabularyShowRowControl.showInfo(map,
									ShowRowInfo.InfoName_Vocabulary);
							((CardLayout) panel_vocabulary_editbar.getLayout())
									.show(panel_vocabulary_editbar,
							...
							cardboxShowRowControl.showInfo(map2,
									ShowRowInfo.InfoName_CardBox_Vocabulary_Editbar_Add);
							vocabularyShowRowControl.getEventResultMap()
									.clear();
		...
		panel_main_centerbar.setBorder(new SoftBevelBorder(BevelBorder.LOWERED,
				null, null, null, null));
	...
	private boolean judgeTest() {
		...
		if (testQuestionControl.isTesting()) {
			int result = JOptionPane.showConfirmDialog(this, "測驗仍在進行中,是否離開?",
					"測驗中", JOptionPane.YES_NO_OPTION,
	...
	private void createVocabularyPanel() {
		ShowRowInfo info_query_vocabulary = new ShowRowInfo(
				ShowRowInfo.InfoName_Vocabulary) {
			@Override
			public void showInfo(Map<String, String> m) {
				JLabel lbl = ((JLabel) this.comps
						.get(ShowRowInfo.Vocabulary_Quantity));
				lbl.setText(lbl.getName() + ":"
						+ m.get(ShowRowInfo.Vocabulary_Quantity));
			}
		};
		ShowRowInfo info_vocabulary_editbar_add = new ShowRowInfo(
				ShowRowInfo.InfoName_Vocabulary_Editbar_Add) {
			@Override
			public void showInfo(Map<String, String> m) {
				((JTextField) this.comps.get(ShowRowInfo.Translation))
						.setText(m.get(ShowRowInfo.Translation));
				((JTextField) this.comps.get(ShowRowInfo.BoxId))
						.setText(m.get(ShowRowInfo.BoxId));
				((JTextField) this.comps.get(ShowRowInfo.Vocabulary))
						.setText(m.get(ShowRowInfo.Vocabulary));
			}
		};
		ShowRowInfo info_vocabulary_editbar_edit = new ShowRowInfo(
				ShowRowInfo.InfoName_Vocabulary_Editbar_Edit) {
			@Override
			public void showInfo(Map<String, String> m) {
				((JTextField) this.comps.get(ShowRowInfo.Translation))
						.setText(m.get(ShowRowInfo.Translation));
		...
		panel_main_centerbar.add(panel_vocabulary,
				CardLayout_topbar_Vocabulary);
		panel_vocabulary
				.setLayout(new BoxLayout(panel_vocabulary, BoxLayout.Y_AXIS));

		JPanel panel_vocabulary_title_1 = new JPanel();
		panel_vocabulary.add(panel_vocabulary_title_1);
		panel_vocabulary_title_1.setLayout(
				new BoxLayout(panel_vocabulary_title_1, BoxLayout.Y_AXIS));
		...
		JButton btnNewButton_8 = new JButton(
				InfoProperty.getInfo(InfoProperty.Create));
		btnNewButton_8.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				vocabularyShowRowControl.setEventResultIdx(-1);
				vocabularyShowRowControl.showRow();
				((CardLayout) panel_vocabulary_editbar.getLayout())
						.show(panel_vocabulary_editbar, CardLayout_Editbar_Add);
			}
		});
		btnNewButton_8.setToolTipText("create new word");
		btnNewButton_8.setBorder(new SoftBevelBorder(BevelBorder.RAISED, null,
				null, null, null));
		...
		JLabel lblNewLabel_10 = new JLabel(
				InfoProperty.getInfo(InfoProperty.Quantity));
		lblNewLabel_10.setName(InfoProperty.getInfo(InfoProperty.Quantity));
		info_query_vocabulary.add(lblNewLabel_10,
				ShowRowInfo.Vocabulary_Quantity);
		...
		panel_vocabulary_editbar.setBorder(new SoftBevelBorder(
				BevelBorder.RAISED, null, null, null, null));
		...
		comboBox.setModel(new DefaultComboBoxModel<String>(
				new String[] { "Vocabulary", "Translation", "Box ID" }));
		...
		btnNewButton_14.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String vocab = ((JTextField) vocabularyShowRowControl
						.getInfo(ShowRowInfo.InfoName_Vocabulary_Editbar_Add)
						.getComponent(ShowRowInfo.Vocabulary)).getText();
				String trans = ((JTextField) vocabularyShowRowControl
						.getInfo(ShowRowInfo.InfoName_Vocabulary_Editbar_Add)
						.getComponent(ShowRowInfo.Translation)).getText();
				String boxid = ((JTextField) vocabularyShowRowControl
						.getInfo(ShowRowInfo.InfoName_Vocabulary_Editbar_Add)
						.getComponent(ShowRowInfo.BoxId)).getText();
				...
				vocabularyShowRowControl.showInfo(map,
						ShowRowInfo.InfoName_Vocabulary_Editbar_Add);
				((CardLayout) panel_vocabulary_editbar.getLayout()).show(
						panel_vocabulary_editbar, CardLayout_Editbar_Search);
			}
		});
		...
		btnNewButton_14_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String trans = ((JTextField) vocabularyShowRowControl
						.getInfo(ShowRowInfo.InfoName_Vocabulary_Editbar_Edit)
						.getComponent(ShowRowInfo.Translation)).getText();
				String boxid = ((JTextField) vocabularyShowRowControl
						.getInfo(ShowRowInfo.InfoName_Vocabulary_Editbar_Edit)
						.getComponent(ShowRowInfo.BoxId)).getText();
				...
				if (trans != null && !trans.trim().equals("")) {
					if (iboxid == -1 || new CardBoxDao().isExist(iboxid)) {
						...
						btnNewButton_topbar_vocabulary.setActionCommand(
								MouseEvent_RemoteClickUnResetFromIdx);
						btnNewButton_topbar_vocabulary.doClick();
					}
				}
				Map<String, String> map = new HashMap<>();
			...
			public void actionPerformed(ActionEvent e) {
				...
				int r = JOptionPane.showOptionDialog(null,
						String.format("Delete \"%s\" ?",
								getVocabularyShowRowControl().getEventReault()
										.getVocabulary()),
						"Delete Date", JOptionPane.YES_NO_OPTION,
						JOptionPane.WARNING_MESSAGE, null, options, "Delete");
				if (r == JOptionPane.NO_OPTION) {
					return;
				}

				new VocabularyDao().delete(
						getVocabularyShowRowControl().getEventReault().getId());
				btnNewButton_topbar_vocabulary.doClick();
				Map<String, String> map = new HashMap<>();
				map.put(ShowRowInfo.Translation, "");
				map.put(ShowRowInfo.BoxId, "");
		...
		btnNewButton_3_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				sort(SorterFactory.getSorter(VocabulrySorterType.Id),
						btnNewButton_3_1, e, vocabularyShowRowControl);
				vocabularyShowRowControl.showRow();
			}
		});
		...
		btnNewButton_6_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				sort(SorterFactory.getSorter(VocabulrySorterType.Vocabulary),
						btnNewButton_6_1, e, vocabularyShowRowControl);
				vocabularyShowRowControl.showRow();
			}
		});
		...
		btnNewButton_4_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				sort(SorterFactory.getSorter(VocabulrySorterType.Translation),
						btnNewButton_4_1, e, vocabularyShowRowControl);
				vocabularyShowRowControl.showRow();
			}
		});
		...
		btnNewButton_5_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				sort(SorterFactory.getSorter(VocabulrySorterType.BoxId),
						btnNewButton_5_1, e, vocabularyShowRowControl);
				vocabularyShowRowControl.showRow();
			}
		});
		...
		btnNewButton_5_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				sort(SorterFactory.getSorter(VocabulrySorterType.CreateDate),
						btnNewButton_5_1_1, e, vocabularyShowRowControl);
				vocabularyShowRowControl.showRow();
			}
		});
		...
		btnNewButton_7_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				sort(SorterFactory.getSorter(VocabulrySorterType.UpdateDate),
						btnNewButton_7_1, e, vocabularyShowRowControl);
				vocabularyShowRowControl.showRow();
			}
		});
	...
	private <T> void sort(Sorter<T> sorter, JButton button, ActionEvent e,
			ShowRowControl<T> control) {
		sorter.sort(button, e, control);
	}

	private void createCardBoxVocabularyPanel() {
		ShowRowInfo info = new ShowRowInfo(
				ShowRowInfo.InfoName_CardBox_Vocabulary) {
			@Override
			public void showInfo(Map<String, String> m) {
				((JLabel) this.comps.get(ShowRowInfo.ID))
						.setText(m.get(ShowRowInfo.ID));
				((JLabel) this.comps.get(ShowRowInfo.Name))
						.setText(m.get(ShowRowInfo.Name));
				((JLabel) this.comps
						.get(ShowRowInfo.CardBox_Vocabulary_Quantity)).setText(
								m.get(ShowRowInfo.CardBox_Vocabulary_Quantity));
				((JLabel) this.comps.get(ShowRowInfo.Test_time))
						.setText(m.get(ShowRowInfo.Test_time));
				((JLabel) this.comps.get(ShowRowInfo.Test_date))
						.setText(m.get(ShowRowInfo.Test_date));
				((JLabel) this.comps.get(ShowRowInfo.Create_date))
						.setText(m.get(ShowRowInfo.Create_date));
				((JLabel) this.comps.get(ShowRowInfo.Update_date))
						.setText(m.get(ShowRowInfo.Update_date));
			}
		};
		...
		ShowRowInfo info_cardbox_vocabulary_editbar_edit = new ShowRowInfo(
			...
			@Override
			public void showInfo(Map<String, String> m) {
				((JTextField) this.comps.get(ShowRowInfo.Name))
						.setText((m.get(ShowRowInfo.Name)));
			}
		};
		...
		this.cardboxShowRowControl
				.setInfo(info_cardbox_vocabulary_editbar_edit);
		this.cardboxShowRowControl
				.setInfo(info_cardbox_vocabulary_editbar_remove);

		panel_cardbox_vocabulary = new JPanel();
		panel_main_centerbar.add(panel_cardbox_vocabulary,
				MainView.CardLayout_topbar_CardBox_Vocabulary);
		panel_cardbox_vocabulary.setLayout(
				new BoxLayout(panel_cardbox_vocabulary, BoxLayout.Y_AXIS));

		JPanel panel_cardbox_vocabulary_title = new JPanel();
		panel_cardbox_vocabulary.add(panel_cardbox_vocabulary_title);
		panel_cardbox_vocabulary_title.setLayout(new BoxLayout(
				panel_cardbox_vocabulary_title, BoxLayout.Y_AXIS));
		...
		JLabel lblNewLabel_4 = new JLabel(
				InfoProperty.getInfo(InfoProperty.Name));
		...
		JLabel lblNewLabel_7_1 = new JLabel(
				InfoProperty.getInfo(InfoProperty.Test_Time));
		...
		JLabel lblNewLabel_7_1_1 = new JLabel(
				InfoProperty.getInfo(InfoProperty.Test_Date));
		...
		JLabel lblNewLabel_6 = new JLabel(
				InfoProperty.getInfo(InfoProperty.Create_Date));
		...
		JLabel lblNewLabel_7 = new JLabel(
				InfoProperty.getInfo(InfoProperty.Update_Date));
		...
		panel_addandeditname.setBorder(new SoftBevelBorder(BevelBorder.RAISED,
				null, null, null, null));
		...
		JButton btnNewButton_9a = new JButton(
				InfoProperty.getInfo(InfoProperty.Create));
		...
		btnNewButton_9a.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				vocabularyShowRowControl.getEventResultMap().clear();
				vocabularyShowRowControl.showRow();
				((CardLayout) panel_cardbox_vocabulary_editbar.getLayout())
						.show(panel_cardbox_vocabulary_editbar,
								CardLayout_Editbar_Add);
				List<Vocabulary> list = new VocabularyDao()
						.queryExceptHadBoxID();
				((MainView) vocabularyShowRowControl.getEventJFrame())
						.getVocabularyShowRowControl().setResults(list);
				((MainView) vocabularyShowRowControl.getEventJFrame())
						.getVocabularyShowRowControl().showRow();
				Map<String, String> map = new HashMap<>();
				map.put(ShowRowInfo.Cardbox_Editbar_add_lock,
						CardVocabulary_Add);
				cardboxShowRowControl.showInfo(map,
						ShowRowInfo.InfoName_CardBox_Vocabulary_Editbar_Add);
				/*
				 * 關閉Editbar EditPanel
				 */
				JPanel editpanel = (JPanel) cardboxShowRowControl.getInfo(
						ShowRowInfo.InfoName_CardBox_Vocabulary_Editbar_Edit)
						.getComponent(ShowRowInfo.EditbarEditPanel);
				JPanel fieldpanel = (JPanel) cardboxShowRowControl.getInfo(
						ShowRowInfo.InfoName_CardBox_Vocabulary_Editbar_Edit)
		...
		btnNewButton_16.setBorder(new SoftBevelBorder(BevelBorder.RAISED, null,
				null, null, null));
		...
		btnNewButton_9a.setBorder(new SoftBevelBorder(BevelBorder.RAISED, null,
				null, null, null));
		...
		info_cardbox_vocabulary_editbar_edit.add(
				panel_cardbox_vocabulary_editbar_editpanel,
		...
		btnNewButton_10.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int eventRowIdx = ShowRowControl.getEventRowIdx(
						cardboxShowRowControl.getEventResultIdx(),
						cardboxShowRowControl.getFromIdx());
				CardBoxRow eventP = (CardBoxRow) panel_cardbox
						.getComponent(eventRowIdx + 1);// 取得事件panel
				eventP.getMouseListeners()[0]
						.mousePressed(eventP.getLastMouseEvent());// 執行click
				JPanel editpanel = (JPanel) cardboxShowRowControl.getInfo(
						ShowRowInfo.InfoName_CardBox_Vocabulary_Editbar_Edit)
						.getComponent(ShowRowInfo.EditbarEditPanel);
				JPanel fieldpanel = (JPanel) cardboxShowRowControl.getInfo(
				...
				if (fieldpanel.isVisible()) {
					...
					JTextField f = (JTextField) cardboxShowRowControl.getInfo(
							ShowRowInfo.InfoName_CardBox_Vocabulary_Editbar_Edit)
					...
					boolean checked = cardboxShowRowControl.getEventReault()
							.isFinish();
					chckbxNewCheckBox_finish.setEnabled(!checked);
					chckbxNewCheckBox_finish.setSelected(
							cardboxShowRowControl.getEventReault().isFinish());

					((CardLayout) ((MainView) cardboxShowRowControl
							.getEventJFrame())
									.getPanel_cardbox_vocabulary_editbar()
									.getLayout()).show(
											((MainView) cardboxShowRowControl
													.getEventJFrame())
															.getPanel_cardbox_vocabulary_editbar(),
		...
		btnNewButton_10.setBorder(new SoftBevelBorder(BevelBorder.RAISED, null,
				null, null, null));
		...
		chckbxNewCheckBox_finish.setBorder(new SoftBevelBorder(
				BevelBorder.RAISED, null, null, null, null));
		info_cardbox_vocabulary_editbar_edit.add(chckbxNewCheckBox_finish,
				ShowRowInfo.IsFinish);
		chckbxNewCheckBox_finish.setFont(new Font("新細明體", Font.PLAIN, 14));
		panel_cardbox_vocabulary_editbar_editpfeild
				.add(chckbxNewCheckBox_finish);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int r = JOptionPane.showOptionDialog(null,
						String.format("Delete \"%s\" ?",
								cardboxShowRowControl.getEventReault()
										.getName()),
						"Delete Date", JOptionPane.YES_NO_OPTION,
						JOptionPane.WARNING_MESSAGE, null, options, "Delete");
				if (r == JOptionPane.NO_OPTION) {
		...
		btnNewButton_17.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int result = JOptionPane.showConfirmDialog(thisApp,
		...
		btnNewButton_17.setBorder(new SoftBevelBorder(BevelBorder.RAISED, null,
				null, null, null));
		...
		btnNewButton.setBorder(new SoftBevelBorder(BevelBorder.RAISED, null,
				null, null, null));
		...
		JPanel panel_2_1 = new JPanel();
		panel_addandeditname.add(panel_2_1);
		...
		btnDownload.setToolTipText("delete this card-box");
		btnDownload.setFont(new Font("Dialog", Font.PLAIN, 16));
		btnDownload.setBorder(new SoftBevelBorder(BevelBorder.RAISED, null,
				null, null, null));
		btnDownload.setBackground(SystemColor.controlHighlight);
		panel_addandeditname.add(btnDownload);
		...
		panel_serch
				.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
		panel_cardbox_vocabulary_editbar.add(panel_serch,
				CardLayout_Editbar_Search);
		...
		info_cardbox_vocabulary_editbar_add.add(panel_adda,
				ShowRowInfo.Cardbox_Editbar_add_lock);
		panel_cardbox_vocabulary_editbar.add(panel_adda,
				CardLayout_Editbar_Add);
		...
		btnNewButton_14a.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				List<Vocabulary> v = vocabularyShowRowControl
						.getEventResultMap().values().stream()
						.collect(Collectors.toList());
		...
		panel_cardbox_vocabulary_editbar.add(panel_edit,
				CardLayout_Editbar_edit);
		panel_edit.setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));
		...
		btnNewButton_14_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				/**
				 * 政策性選用 Vocabulary v =
				 * vocabularyShowRowControl.getEventReault(); v.setBox_id(-1);
				 * new VocabularyDao().update(v, v.getId());
				 */
				vocabularyShowRowControl.getEventResultMap().values()
						.forEach(x -> {
							x.setBox_id(-1);
		...
		btnNewButton_3_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				sort(SorterFactory.getSorter(VocabulrySorterType.Id),
						btnNewButton_3_1_1, e, vocabularyShowRowControl);
		...
		btnNewButton_6_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				sort(SorterFactory.getSorter(VocabulrySorterType.Vocabulary),
						btnNewButton_6_1_1, e, vocabularyShowRowControl);
				vocabularyShowRowControl.resetEventResultMap();
				vocabularyShowRowControl.showRow();
			}
		});
		...
		btnNewButton_4_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				sort(SorterFactory.getSorter(VocabulrySorterType.Translation),
						btnNewButton_4_1_1, e, vocabularyShowRowControl);
				vocabularyShowRowControl.resetEventResultMap();
				vocabularyShowRowControl.showRow();
			}
		});
		...
		btnNewButton_4_1_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				sort(SorterFactory.getSorter(VocabulrySorterType.BoxId),
						btnNewButton_4_1_1_1, e, vocabularyShowRowControl);
				vocabularyShowRowControl.resetEventResultMap();
				vocabularyShowRowControl.showRow();
			}
		});
		...
		btnNewButton_5_1_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				sort(SorterFactory.getSorter(VocabulrySorterType.CreateDate),
						btnNewButton_5_1_1_1, e, vocabularyShowRowControl);
				vocabularyShowRowControl.resetEventResultMap();
				vocabularyShowRowControl.showRow();
			}
		});
		...
		btnNewButton_7_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				sort(SorterFactory.getSorter(VocabulrySorterType.UpdateDate),
						btnNewButton_7_1_1, e, vocabularyShowRowControl);
				vocabularyShowRowControl.resetEventResultMap();
				vocabularyShowRowControl.showRow();
			}
		});
	...
	private void createTestPanel() {
		...
		btnNewButton_11.setBorder(new SoftBevelBorder(BevelBorder.RAISED, null,
				null, null, null));
		...
		btnNewButton_12.setBorder(new SoftBevelBorder(BevelBorder.RAISED, null,
				null, null, null));
		...
		btnNewButton_13.setBorder(new SoftBevelBorder(BevelBorder.RAISED, null,
				null, null, null));
		...
		panel_test_center_cardlayout.add(panel_question,
				CardLayout_Test_Question);
	...
	private void createCardBoxPanel() {
		ShowRowInfo info = new ShowRowInfo(ShowRowInfo.InfoName_CardBox) {
			...
			public void showInfo(Map<String, String> m) {
				JLabel lbl = ((JLabel) this.comps
						.get(ShowRowInfo.CardBox_Quantity));
				lbl.setText(lbl.getName() + ":"
						+ m.get(ShowRowInfo.CardBox_Quantity));
			}
		};
		ShowRowInfo info_cardbox_editbar_add = new ShowRowInfo(
				ShowRowInfo.InfoName_CardBox_Editbar_Add) {
			@Override
			public void showInfo(Map<String, String> m) {
				((JTextField) this.comps.get(ShowRowInfo.Name))
						.setText(m.get(ShowRowInfo.Name));
		...
		panel_cardbox_title.setLayout(
				new BoxLayout(panel_cardbox_title, BoxLayout.Y_AXIS));
		...
		btnNewButton_8.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				((CardLayout) panel_cardbox_editbar.getLayout())
						.show(panel_cardbox_editbar, CardLayout_Editbar_Add);
			}
		});
		btnNewButton_8.setBorder(new SoftBevelBorder(BevelBorder.RAISED, null,
				null, null, null));
		...
		btnNewButton_14.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JTextField t = (JTextField) cardboxShowRowControl
						.getInfo(ShowRowInfo.InfoName_CardBox_Editbar_Add)
						.getComponent(ShowRowInfo.Name);
				c.setName(t.getText());
		...
		btnNewButton_15.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				((CardLayout) panel_cardbox_editbar.getLayout())
						.show(panel_cardbox_editbar, CardLayout_Editbar_Search);
			}
		});
		btnNewButton_15.setFont(new Font("新細明體", Font.PLAIN, 14));
		btnNewButton_15.setBackground(SystemColor.controlHighlight);
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				sort(SorterFactory.getSorter(CardBoxSorterType.Id),
						btnNewButton_3, e, cardboxShowRowControl);
				cardboxShowRowControl.showRow();
			}
		});
		...
		btnNewButton_6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				sort(SorterFactory.getSorter(CardBoxSorterType.Name),
						btnNewButton_6, e, cardboxShowRowControl);
				cardboxShowRowControl.showRow();
			}
		});
		...
		btnNewButton_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				sort(SorterFactory.getSorter(CardBoxSorterType.Quantity),
						btnNewButton_4, e, cardboxShowRowControl);
				cardboxShowRowControl.showRow();
			}
		});
		...
		btnNewButton_4_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				sort(SorterFactory.getSorter(CardBoxSorterType.TestTimes),
						btnNewButton_4_1, e, cardboxShowRowControl);
				cardboxShowRowControl.showRow();
			}
		});
		...
		btnNewButton_4_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				sort(SorterFactory.getSorter(CardBoxSorterType.TestDate),
						btnNewButton_4_2, e, cardboxShowRowControl);
				cardboxShowRowControl.showRow();
			}
		});
		...
		btnNewButton_4_2_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				sort(SorterFactory.getSorter(CardBoxSorterType.NestTest),
						btnNewButton_4_2_1, e, cardboxShowRowControl);
				cardboxShowRowControl.showRow();
			}
		});
		...
		btnNewButton_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				sort(SorterFactory.getSorter(CardBoxSorterType.CreateDate),
						btnNewButton_5, e, cardboxShowRowControl);
				cardboxShowRowControl.showRow();
			}
		});
		...
		btnNewButton_7.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				sort(SorterFactory.getSorter(CardBoxSorterType.UpdateDate),
						btnNewButton_7, e, cardboxShowRowControl);
				cardboxShowRowControl.showRow();
			}
		});
